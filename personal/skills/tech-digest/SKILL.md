---
name: tech-digest
description: Daily curated tech reading list — Hacker News plus targeted web searches across the areas you follow (web/frontend, AI/LLM, backend/infra, Shopify, crypto/web3, security, DSA), grouped into hot / work-relevant / broader, each with a Vietnamese line on why it's worth reading, saved to a dated file. Also saves articles for later (save <N>) and follows sources (follow <url|name>) that later digests fetch first. Grounded in sources fetched that run, never recalled or invented. Use when asked for "tech news", "what's new in tech", "daily digest", "reading list", "/tech-digest", or to save or follow something worth tracking.
---
